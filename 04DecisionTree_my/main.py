...
from class_DecisionTreeClassifier import SingleLabelDecisionTreeClassifier, MultiLabelDecisionTreeClassifier
...
clf = MultiLabelDecisionTreeClassifier(fv_dimension=len(training_ds.fv_nparray[0,:]), min_split_entropy_threshold=0.0)
# Preprocessing - MultiLabelBinarizer
mlb = MultiLabelBinarizer(classes=training_ds.classes_, sparse_output=False)
training_ds.cl_indicator_matrix = mlb.fit_transform(training_ds.class_label_lists)
